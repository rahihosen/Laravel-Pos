...
class PurchaseOraddController extends Controller
{
...
//      }
    ...
    public function purchaseProductSave (Request $request) 
    {
        ...
        return Redirect::to('/purchase-add');
    ...
    public function viewPurchaseInvoiceOrder (Request $request) 
    {
        ...
        $ren_data .= '  <tr>
                        ...
                        <tr>
                            <td><b>Note: ' . $purchase_val->purchase_note . '</b><br></td>
                        </tr>
                    ';
    ...
    public function viewPurchaseInvoiceOrderList (Request $request) 
    {
        ...
        foreach ($purchase_data as $purchase_data) {
            ...
            $ren_data .= '<tr class="even pointer">
                            ...
                            <td>' . $purchase_data->product_purchase_price . '</td>
                            <td>' . $purchase_data->product_qty * $purchase_data->product_purchase_price . '</td>
                        </tr>';
        }
    ...
    public function purchaseoradd () 
    {
        ...
        $all_product2 = DB::table('product')
            ...
            ->orderByRaw('stock.product_id','DESC')
            ->paginate(10);

        $new_purchase = view('admin.pages.purchaseoradd')
                        ->with('all_buyers', $all_buyers)
                        ->with('all_accounts', $all_accounts)
                        ->with('all_product_info', $all_product)
                        ->with('all_product_info2', $all_product2)
     ...
     public function saveBuyer2 (Request $request) 
    {
...
//      }
    ...
    public function searchProductList(Request $request)
    {
     ...
     public function showExpiredProduct ()
    {
        ...
        $all_purchase = DB::table('purchase')
                        ...
                        ->orderBy('purchase_id', 'DESC')
                        ->where('purchase_status', 1)
                        ->whereRaw('DATEDIFF(expire_date,purchase_created_date) <= 60')
                        ->paginate(10);

        $purchase_list = view('admin.pages.expired_product_list')->with('all_purchase', $all_purchase);
     ...
     public function aboutApp () 
    {
        ...
        $product_list = view('admin.pages.about_app')->with('all_product_info', $all_product);
