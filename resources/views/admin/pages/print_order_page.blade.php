...
<html lang="en">
    ...
    <body class="print_page">
        ...
        <table class="table_prc" style="border-top:1px solid lightgray;">
            ...
            <!--<tr>-->
            <!--    <td colspan="4" style="text-align: left;width: 70%;"><i class="fas fa-dot-circle"></i> বিক্রিত পন্য ফেরতযোগ্য, তাই ক্রয় করার ১৫ দিনের মধ্যে ক্যাশমেমো সহ যোগাযোগ করুন।</td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--    <td colspan="4" style="text-align: left;width: 70%;"><i class="fas fa-dot-circle"></i> বৈধ প্রেসক্রিপশনের মাধ্যমে গুণগত মান সম্পন্ন ঔষধ কেনার নির্ভরযোগ্য প্রতিষ্ঠান।</td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--    <td colspan="4" style="text-align: left;width: 70%;"><i class="fas fa-dot-circle"></i> মেসার্স সীবলী ফার্মেসী থেকে পন্য ক্রয় করে শিক্ষা ক্ষেত্রে মানবিক অবদান রাখার জন্য ধন্যবাদ।</td>-->
            <!--</tr>-->
            <!--<tr>-->
            <!--    <td colspan="4" style="text-align: left;width: 70%;"><i class="fas fa-dot-circle"></i> বিস্তারিত জানতে ভিজিট করুন: www.shibaligroup.com ফোন করুন: 01814 39 40 82 </td>-->
            <!--</tr>-->
            <!--<tr>-->
