						...
						<div class="no_padding col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12"> 
						    ...
						    <div id="print_page">
						        ...
						        <br/><br/><br/><br/><br/>
                                    ...
                                    <h4 style="text-align: center">CALAN</h4><br/>
                                    ...
                                    <div style='padding-top:8px; text-align:center; font-size:15px; font-family: Source Sans Pro, Arial, sans-serif;'>
        								...
        								<hr style="margin-top: 2px;margin-bottom: 20px; border: 0; border-top: 1px solid black;">
        								<br/><br/><br/><br/><br/><br/><br/><br/>
        								<table style="width: 150%;">
        								    <tr>
        										<td colspan="4"><hr style="width: 130px;margin-left: 0;border-top: 1px solid #241919; margin-bottom: 1px;"></td>
        										<td><hr style="width: 90px;margin-left: 0;border-top: 1px solid #241919;margin-bottom: 1px;"></td>
        									</tr>
...
<script>
    $(document).ready(function() {
		...
		$(document).on('click', '.print', function() {
			...
			WinPrint.document.writeln('<html><head><title></title><style>..hide_print_sec {display:none;} table td {padding:0px !important; font-size: 11px;}</style>');
