                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 no_padding">
                            ...
                            <div class="login login-container">
                                ...
                                <div class="form-signin">
                                    ...
                                    <div class="alert alert-rose alert-with-icon" data-notify="container">
                                        ...
                                        <button aria-label="Close" class="close mat-button" data-dismiss="alert" mat-button="" type="button">
                                        ...
                                        <span data-notify="message"> {{ session()->get('err') }} </span>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <input name="email" type="email" id="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="Email address" required autofocus>
                        ...
                        <div class="col-md-6 col-sm-6 hidden-xs">
                            <div class="col-md-12 col-sm-12 col-xs-12 company-title">
                                ...
                                <p>Digital Journey for skilled Bangladesh</p>
